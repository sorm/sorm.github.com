...
* **Multithreading**. A single SORM instance can safely be used accross multiple threads and seamlessly integrates into actor-based concurrent systems, like Akka.
